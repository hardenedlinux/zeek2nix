...
nix run github:hardenedlinux/zeek2nix
#+end_src
...
#+begin_src sh :async t :exports both :results output
# flake feature
nix build github:hardenedlinux/zeek2nix
# or
nix-build
#+end_src

* Build Zeek Env with nix-shell(shell mode) - release version
#+begin_src sh :async t :exports both :results output
nix develop github:hardenedlinux/zeek2nix
# or
nix-shell
#+end_src
