...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  zeek-latest = {
    pname = "zeek-latest";
    version = "6a4c8e4e701af6ea5bcb4a979e5a962dcd61846d";
    src = fetchFromGitHub ({
      owner = "zeek";
      repo = "zeek";
      rev = "6a4c8e4e701af6ea5bcb4a979e5a962dcd61846d";
      fetchSubmodules = true;
      sha256 = "sha256-KPMjQj2JoN/FAQ1X24mgQsGFlE2nhSN7xXsPNoS4g7w=";
    });
  };
  ...
  zeek-plugin-spicy = {
    ...
    version = "8cd9a0b9f38f130422f821966a3e865e59e8c036";
    src = fetchFromGitHub ({
      owner = "zeek";
      repo = "spicy-plugin";
      rev = "8cd9a0b9f38f130422f821966a3e865e59e8c036";
      fetchSubmodules = false;
      sha256 = "sha256-4H2C5e8ywSf5SVH1sJDQOqN92wo0m4u1Hnl+2sIx6Ys=";
    });
  };
  zeek-release = {
    pname = "zeek-release";
