...
{ fetchgit, fetchurl }:
{
  ...
  zeek-latest = {
    pname = "zeek-latest";
    version = "d1c6e9e226fb0fbdad683cf0e9bc2f6109904135";
    src = fetchgit {
      url = "https://github.com/zeek/zeek";
      rev = "d1c6e9e226fb0fbdad683cf0e9bc2f6109904135";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0s1ajpwkxxdww3i5fmbv79asa9bhcnww1crlvi5fmcf8ch6bar69";
    };
  };
  ...
  zeek-plugin-http2 = {
    ...
    src = fetchgit {
      ...
      deepClone = false;
      leaveDotGit = false;
      sha256 = "03xsw36ir6f2kxnycy83i4qn7wrwx7gr31968m3mnw2zbmcvmcqi";
    };
  };
  zeek-plugin-ikev2 = {
  ...
  zeek-spicy-analyzers = {
    ...
    version = "3c09a13b0e08cf16b06ea94bdf51efb28808b3a3";
    src = fetchgit {
      url = "https://github.com/zeek/spicy-analyzers";
      rev = "3c09a13b0e08cf16b06ea94bdf51efb28808b3a3";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "0m75nnbl86xs95qqlqaj4hn4avz9wjrc1g257m3w59nk0vp12znn";
    };
  };
  zeek-tls = {
    pname = "zeek-tls";
