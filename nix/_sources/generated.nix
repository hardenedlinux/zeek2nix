...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  ...
  zeek-latest = {
    pname = "zeek-latest";
    version = "e0b465948838c1b514c1a3d08dfdc9436b1d44b8";
    src = fetchFromGitHub ({
      owner = "zeek";
      repo = "zeek";
      rev = "e0b465948838c1b514c1a3d08dfdc9436b1d44b8";
      fetchSubmodules = true;
      sha256 = "sha256-7Ad6kKdWB9asiAtsxepP9p4LjYVKweyiKMIBd29B0og=";
    });
  };
  ...
  zeek-plugin-spicy = {
    ...
    version = "2331bb0522ed104685c94036e60fb49ee43d9821";
    src = fetchFromGitHub ({
      owner = "zeek";
      repo = "spicy-plugin";
      rev = "2331bb0522ed104685c94036e60fb49ee43d9821";
      fetchSubmodules = false;
      sha256 = "sha256-uuMOjHfJWe2oV6bgjZeMYaWq0ddf9sEughxRmn/gJ0U=";
    });
  };
  zeek-plugin-zip = {
